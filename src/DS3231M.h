...
*
* Use is made of portions of Adafruit's RTClib Version 1.2.0 at https://github.com/adafruit/RTClib which is a fork 
* of the original RTClib from Jeelabs. The code encompasses simple classes for time and date.
*
...
*******************************************************************************************************************/
enum alarmTypes {everySecond,secondsMatch,secondsMinutesMatch,secondsMinutesHoursMatch,secondsMinutesHoursDateMatch,
                 secondsMinutesHoursDayMatch,everyMinute,minutesMatch,minutesHoursMatch,minutesHoursDateMatch,
                 minutesHoursDayMatch,UnknownAlarm};
/***************************************************************************************************************//*!
* @brief Declare the enumerated frequencies of pinSquareWave that can be set
*******************************************************************************************************************/
enum frequencies {_1hz,_1khz,_4khz,_8khz};
...
*****************************************************************************************************************/
  ...
  const uint32_t SECONDS_FROM_1970_TO_2000 = 946684800; ///< Number of seconds betwen 1970/1/1 to 2000/1/1
...
* @details  Class has no  TZ / DST / leap second handling. Copied from RTClib. For further information on this 
*           implementation see https://github.com/SV-Zanshin/DS3231M/wiki/DateTimeClass
*******************************************************************************************************************/
  class DateTime 
  {
    public:
...
* @details  Timespan class which can represent changes in time with seconds accuracy. Copied from RTClib. For
*           further information see ** https://github.com/SV-Zanshin/DS3231M/wiki/TimeSpanClass
*******************************************************************************************************************/
  class TimeSpan 
  {
    public:
...
*******************************************************************************************************************/
  class DS3231M_Class
  {
    public:
      ...
      void     setAlarm(const uint8_t alarmType, const DateTime dt, const bool state = true ); // Set an Alarm
      ...
      void     pinSquareWave(const int8_t freq);                              // Make the INTSQW be a square signal at frequency
    private:
